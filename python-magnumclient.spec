...
Source0  : http://tarballs.openstack.org/python-magnumclient/python-magnumclient-3.0.0.tar.gz
Source1  : http://tarballs.openstack.org/python-magnumclient/python-magnumclient-3.0.0.tar.gz.asc
...
%prep
%setup -q -n python-magnumclient-3.0.0
cd %{_builddir}/python-magnumclient-3.0.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1586356847
...
cp %{_builddir}/python-magnumclient-3.0.0/LICENSE %{buildroot}/usr/share/package-licenses/python-magnumclient/c700a8b9312d24bdc57570f7d6a131cf63d89016
