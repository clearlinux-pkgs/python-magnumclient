...
Source0  : http://tarballs.openstack.org/python-magnumclient/python-magnumclient-2.12.0.tar.gz
Source99 : http://tarballs.openstack.org/python-magnumclient/python-magnumclient-2.12.0.tar.gz.asc
...
%prep
%setup -q -n python-magnumclient-2.12.0
...
export LANG=C
export SOURCE_DATE_EPOCH=1551928933
